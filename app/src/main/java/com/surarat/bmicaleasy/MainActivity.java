package com.surarat.bmicaleasy;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void calBMI(){
        EditText texttw = (EditText)findViewById(R.id.editText_weight);
        EditText texth = (EditText)findViewById(R.id.editText2_hight);

        double w = Double.parseDouble(texttw.getText().toString());
        ...
        else if (bmi >= 35.5) msg += "อ้วนขั้นที่1";
        else if (bmi >= 23.5) msg += "น้ำหนักเกิน";
        else if (bmi >= 18.5) msg += "อยู้ในเกณฑ์ปกติ";
